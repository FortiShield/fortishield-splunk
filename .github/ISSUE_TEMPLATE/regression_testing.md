...
title: 'Release [FORTISHIELD VERSION] - Release Candidate [RC VERSION] - Splunk UI regression testing'
...
See [Supported versions](https://github.com/fortishield/fortishield-splunk/wiki/Compatibility).
