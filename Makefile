...
# ---------------------------------------------
# 
# Portions Copyright (C) 2015-2022, Fortishield Inc.
...
# SOURCES AND PATHS
#--------------------------------------------------------------------#
APP_DIR = SplunkAppForFortishield
PACKAGE_NAME = SplunkAppForFortishield.tar.gz
...
# Update the Fortishield version, the Splunk version and the App's revision number 
...
# Update the API info. The Fortishield API must be running and reachable locally.
api-info:
	@echo "$(BWhite)- Updating the FORTISHIELD API endpoints local registry ...$(Color_Off)"
	@FORTISHIELD_API_URL=https://0.0.0.0:55000 npm run generate:api-info
...
pretty: clean
	...
	SplunkAppForFortishield/**/*.js \
	SplunkAppForFortishield/**/*.html \
	SplunkAppForFortishield/**/*.css \
	!SplunkAppForFortishield/appserver/static/js/libs/** \
	!SplunkAppForFortishield/appserver/static/js/utils/codemirror/**