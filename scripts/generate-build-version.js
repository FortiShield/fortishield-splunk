...
// ------------------------------------------------------------------------- //
//  Update appVersionService.js with latest Fortishield version and revision number.
// ------------------------------------------------------------------------- //
function updateAppVersionServiceFile() {
  const FILE = './SplunkAppForFortishield/appserver/static/js/services/app-version/appVersionService.js'
...
function updatePackageConfFile() {
  const FILE = './SplunkAppForFortishield/default/package.conf'
...
// ------------------------------------------------------------------------- //
//  Update app.conf with latest Fortishield version and App's revision number.
// ------------------------------------------------------------------------- //
function updateAppConfFile() {
  const FILE = './SplunkAppForFortishield/default/app.conf'
