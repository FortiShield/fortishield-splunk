...
from log import log
from fortishieldtoken import fortishieldtoken


class Fortishield_API():
    """
    Fortishield_API class.

    Handle the requests sent to the Fortishield API.
    """
    ...
    def __init__(self):
        ...
        try:
            ...
            self.logger.error(
                "fortishield-api: error in the constructor: %s" % (e))
    ...
    def make_request(
        ...
        """
        Use this method to launch response to a Fortishield API.
        ...
        try:
            ...
            fortishield_token = self.wztoken.get_auth_token(current_api)
            if method == 'GET':
                if 'origin' in kwargs:
                    if kwargs['origin'] == 'xmlreader':
                        response_xml = self.session.get(
                            ...
                            headers={
                                'Authorization': f'Bearer {fortishield_token}'
                            },
