...
FORTISHIELD_HOME = os.path.join(SPLUNK_HOME, "etc", "apps", "SplunkAppForFortishield")

LOGGER = log()


def get_default_conf_path(filename: str) -> str:
    """Returns the absolute path to $FORTISHIELD_HOME/default/${filename}"""
    return os.path.join(FORTISHIELD_HOME, "default", filename)


def get_default_conf(filename: str, stanza: str) -> dict:
    """
    Reads the file $FORTISHIELD_HOME/default/${file} and returns its contents as a
    dictionary.
    ...
    try:
        ...
        # https://github.com/fortishield/fortishield-splunk/pull/1340#discussion_r900338325
        # ------------------------------
        # app_conf = cli.getAppConf(
        #     confName="app",
        #     app="SplunkAppForFortishield",
        #     use_btool=False,
        #     app_path=FORTISHIELD_HOME
        # )
        # ------------------------------
