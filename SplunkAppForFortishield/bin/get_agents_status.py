# -*- coding: utf-8 -*-
"""
Fortishield app - Agents status polling script.
...
def check_status():
    ...
    try:
        ...
        for api in apis:
            ...
            url = api.get_url()
            fortishield_token = wztoken.get_auth_token(api)
            ...
            try:
                request_agents = requestsbak.get(
                    ...
                    headers={'Authorization': f'Bearer {fortishield_token}'},
                    timeout=1,
                    verify=False
                ).json()
