...
define(['../../module', '../../../dashboardMain'], function (
  ...
  class AgentsCA extends DashboardMain {
    ...
    constructor(
      ...
      this.scope.noScansPng = `${this.baseUrl}/static/app/SplunkAppForFortishield/css/images/sca_no_scans.png`
    ...
    $onInit() {
      this.scope.searchRootcheck = (term, specificFilter) =>
        this.scope.$broadcast('fortishieldSearch', { term, specificFilter })
