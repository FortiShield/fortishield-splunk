  ...
  class Logs {
    ...
    $onInit() {
      try {
        ...
        this.scope.$on('fortishieldFetched', (ev, params) => {
          ev.stopPropagation()
     ...
     */
    sort() {
      this.scope.$broadcast('fortishieldSort', { field: 'timestamp' })
    }
    ...
    async changeNode(node) {
      try {
        ...
        this.scope.$broadcast('fortishieldUpdateInstancePath', {
     ...
     */
    async filter(filter) {
      this.scope.$broadcast('fortishieldFilter', { filter })
    }
    ...
    playRealtime() {
      ...
      this.scope.$broadcast('fortishieldPlayRealTime')
    }
    ...
    stopRealtime() {
      this.scope.realtime = false
      this.scope.$broadcast('fortishieldStopRealTime')
    }
  }
