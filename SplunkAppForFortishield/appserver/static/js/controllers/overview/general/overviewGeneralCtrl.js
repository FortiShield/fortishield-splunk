  ...
  class OverviewGeneral extends DashboardMain {
    ...
    constructor(
      ...
      this.vizz = [
        ...
        new PieChart(
          'alertsEvoTop5Agents',
          `${this.filters} index=fortishield  | stats count by agent.name`,
          'alertsEvoTop5Agents',
          this.scope
        ),
        new PieChart(
        ...
        if (!this.pollingEnabled) {
          ...
          try {
            ...
            if (nodeType === 'manager.name') {
              ...
              agentsStatusFilter = `manager.name=${managerName} index=fortishield-monitoring*`
            } else {
              const clusterName = filters['cluster.name']
              agentsStatusFilter = `cluster.name=${clusterName} index=fortishield-monitoring*`
            }
