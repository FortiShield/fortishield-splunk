/*
 * Fortishield app - Mitre Ids controller
--
  ...
  class OverviewMitreIds {
    ...
    loadModalEventsTable() {
      ...
      const table = new Table(
        ...
        `index=fortishield ${this.filters} \
        sourcetype=fortishield rule.mitre.id{}=${this.scope.selectedItem.external_id} \
    ...
    loadTacticsTechniques(earliest_time, latest_time) {
      ...
      this.tacticsSearch = new SearchHelper({
        id: 'tacticsCount',
        search: `index=fortishield ${this.filters} rule.mitre.id{}=* | stats count by rule.mitre.tactic{} | sort - count`,
      ...
      this.techniquesSearch = new SearchHelper({
        id: 'techniquesCount',
        search: `index=fortishield ${this.filters} rule.mitre.id{}=* | stats count by rule.mitre.id{} | sort - count`,
        ...
        this.$mdDialog.show({
          ...
          template: `
            <md-dialog aria-label="List dialog" style="min-height:80%;max-width: 75%;">
                ...
                <md-dialog-content class="_md flex fortishield-column wz-margin-top-10">
                    ...
                    <div class="pos-rel">
                        ...
                        <div>
                            <div style="display:flex;" >
                                <fortishield-bar flex></fortishield-bar>
