define(['./module'], function (app) {
  app.factory('$apiResponseModelFactory', function () {
     ...
     * Success model class.
     *
     * Intended for being used when the Fortishield API replies with status codes:
     *   - 200 OK
     *
     ...
     * or similar. Otherwise, use the concrete classes for Fortishield API responses.
     */
     ...
     * Simple error model.
     *
     * Intended for use when the Fortishield API replies with status codes:
     *   - 400 Bad Request
     *   - 401 Unauthorized
