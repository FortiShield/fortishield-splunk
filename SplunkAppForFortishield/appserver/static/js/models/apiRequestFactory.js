define(['./module'], function (app) {
  app.factory('$apiRequestModelFactory', function ($requestService) {
    ...
    class HttpRequest {
       ...
       * @param {string} path     Fortishield API endpoint
      ...
      /**
       * Sends the request to the backend, meant to be re-sent to the Fortishield API
    ...
    class GetRequest extends HttpRequest {
       ...
       * to be used on the backend's request to the Fortishield API.
       *
