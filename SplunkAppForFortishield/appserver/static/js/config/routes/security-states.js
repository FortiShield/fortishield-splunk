    ...
    function ($stateProvider, BASE_URL) {
      $stateProvider
        .state('security', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/security/main/security.html',
        ...
        .state('security.users', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/security/users/users.html',
          onEnter: ($navigationService) => {
            $navigationService.storeRoute('security.users')
          },
        ...
        .state('security.roles', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/security/roles/roles.html',
          onEnter: ($navigationService) => {
        ...
        .state('security.policies', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/security/policies/policies.html',
          onEnter: ($navigationService) => {
        ...
        .state('security.roles-mapping', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/security/roles-mapping/rolesMapping.html',
          onEnter: ($navigationService) => {
