    ...
    function ($stateProvider, BASE_URL) {
      $stateProvider
        ...
        .state('settings', {
          ...
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/settings/main/settings.html',
        ...
        .state('settings.about', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/settings/about/about.html',
          onEnter: ($navigationService) => {
        ...
        .state('settings.api', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/settings/api/api.html',
          onEnter: ($navigationService) => {
            $navigationService.storeRoute('settings.api')
          },
        ...
        .state('settings.index', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/settings/index/index.html',
          onEnter: ($navigationService) => {
        ...
        .state('settings.logs', {
          templateUrl:
            '/static/app/SplunkAppForFortishield/js/controllers/settings/logs/logs.html',
          onEnter: ($navigationService) => {
        ...
        .state('settings.configuration', {
          templateUrl:
            '/static/app/SplunkAppForFortishield/js/controllers/settings/configuration/configuration.html',
          onEnter: ($navigationService) => {
        ...
        .state('dev-tools', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/dev-tools/dev-tools.html',
          onEnter: ($navigationService) => {
        ...
        .state('discover', {
          templateUrl:
            BASE_URL +
            '/static/app/SplunkAppForFortishield/js/controllers/discover/discover.html',
          onEnter: ($navigationService) => {
