    ...
    function ($stateProvider, BASE_URL) {
      $stateProvider
        ...
        .state('manager', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/welcome/manager-welcome.html',
          onEnter: () => {
        ...
        .state('mg-monitoring', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/monitoring/monitoring.html',
        ...
        .state('mg-logs', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/logs/manager-logs.html',
          onEnter: ($navigationService) => {
        ...
        .state('mg-rules', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/rules/manager-ruleset.html',
          onEnter: ($navigationService) => {
        ...
        .state('mg-rules-id', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/rules/manager-ruleset-id.html',
          onEnter: ($navigationService) => {
            $navigationService.storeRoute('mg-rules')
          },
        ...
        .state('mg-decoders', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/decoders/manager-decoders.html',
          onEnter: ($navigationService) => {
        ...
        .state('mg-decoders-id', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/decoders/manager-decoders-id.html',
          onEnter: ($navigationService) => {
            $navigationService.storeRoute('mg-decoders')
          },
        ...
        .state('mg-cdb', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/cdb/manager-cdb.html',
          onEnter: ($navigationService) => {
        ...
        .state('mg-cdb-id', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/cdb/manager-cdb-id.html',
          onEnter: ($navigationService) => {
            $navigationService.storeRoute('mg-cdb')
          },
        ...
        .state('mg-groups', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/groups/groups.html',
          onEnter: ($navigationService) => {
        ...
        .state('mg-editConfig', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/edition/edition.html',
          onEnter: ($navigationService) => {
        ...
        .state('mg-status', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/status/status.html',
          onEnter: ($navigationService) => {
        ...
        .state('mg-reporting', {
          templateUrl:
            BASE_URL +
            'static/app/SplunkAppForFortishield/js/controllers/management/reporting/reporting.html',
          onEnter: ($navigationService) => {
          ...
          resolve: {
            isFortishieldAdmin: [
              ...
              async ($security_service) => {
                try {
                  return await $security_service.hasFortishieldRole('administrator')
                } catch (error) {
                  return false
                }
              },
