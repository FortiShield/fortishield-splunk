/*
 * Fortishield app - Fortishield upload files directive
    ...
    return {
      ...
      controller($scope, $currentDataService) {
        ...
        $scope.myDropzone = new Dropzone('#myDropzone', {
          url: `en-us/custom/SplunkAppForFortishield/manager/upload_file?apiId=${currentApi}&resource=${$scope.resource}`,
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForFortishield/js/directives/wz-upload-files/wz-upload-files.html',
    }
  })
})
