  ...
  directives.directive('wzMenu', function (BASE_URL) {
    return {
      controller: function (
        ...
        $scope.logoUrl =
          BASE_URL +
          '/static/app/SplunkAppForFortishield/css/images/fortishield/svg/fortishield_white_full.svg'
        ...
        $scope.openDiscover = (agentId) => {
          ...
          $scope.$applyAsync()
          const index = $currentDataService.getIndex().index || 'fortishield'
          //Generate url
        ...
        const renderDropdownIndex = () => {
          ...
          dropdownIndex = new DropdownViz(
            'menuSelectIndex',
            `| metasearch index=* sourcetype=*fortishield* | stats count by index, sourcetype | fields index`,
            'index',
            '$form.index$',
            'menuSelectIndex',
            $scope,
        ...
        const update = async () => {
          try {
            ...
            $scope.menuCurrentIndex = !index ? 'fortishield' : index.index
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForFortishield/js/directives/wz-menu/wz-menu.html',
    }
  })
})
