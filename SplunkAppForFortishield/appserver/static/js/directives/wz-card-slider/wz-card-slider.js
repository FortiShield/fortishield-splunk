/*
 * Fortishield app - Card slider directive
...
define(['../module'], function (directives) {
  'use strict'
  directives.directive('fortishieldCardSlider', function (BASE_URL) {
    return {
      restrict: 'E',
      scope: {
        data: '=data',
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForFortishield/js/directives/wz-card-slider/wz-card-slider.html',
    }
  })
})
