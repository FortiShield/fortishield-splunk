/*
 * Fortishield app - Filter bar directive
...
define(['../module'], function (directives) {
  'use strict'
  directives.directive('fortishieldBar', function ($notificationService, BASE_URL) {
    return {
      restrict: 'E',
      ...
      templateUrl:
        BASE_URL +
        '/static/app/SplunkAppForFortishield/js/directives/wz-bar/wz-bar.html',
    }
  })
})
